...
//            }
    ...
    public RestoredSession restore(SnapApp.SnapContext context, URI rootURI, ProgressMonitor pm,
        ...
        try {
            ...
            ProductNodeView[] views = restoreViews(productManager, context.getPreferences(), SubProgressMonitor.create(pm, 20), problems
            );
...
//                    }
    ...
    private static ProductSceneView createSceneView(ViewRef viewRef,
        ...
        view.appyLayerProperties(applicationPreferences);
        return view;
    }
