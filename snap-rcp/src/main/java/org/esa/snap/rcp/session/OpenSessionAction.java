...
//        SwingWorker<RestoredSession, Object> worker = new OpenSessionWorker(snapApp, sessionFile);
//        worker.execute();
//    }
//
...
//
//        public OpenSessionWorker(SnapApp snapApp, File sessionFile) {
...
//            }
//            return session.restore(snapApp, rootURI, pm, new SessionProblemSolver());
//        }
//
//        @Override
//        protected void done() {
...
//                    return;
//                }
//                snapApp.showErrorDialog(MessageFormat.format("An unexpected exception occurred!\nMessage: {0}",
...
//                snapApp.getProductManager().addProduct(product);
//            }
//
//
...
//                        @Override
//                        public void run() {
//                            answer[0] = snapApp.showQuestionDialog(title, msg, true, null);
//                            if (answer[0] == JOptionPane.YES_OPTION) {
//                                newFile[0] = snapApp.showFileOpenDialog(title, false, null);
//                            }
//                        }
//                    });
//                } catch (Exception e) {
